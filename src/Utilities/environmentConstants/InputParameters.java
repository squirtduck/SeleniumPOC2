 ...
 */
public abstract class InputParameters { //this class is a container for configurable string variables, including xpaths
    ...
    //public map keys for InputParameters -- public because they are used to retrieve the InputParameters from the configuration map
    ...
    public static final String SALESFORCE_LOGIN_URL_KEY = "PARAMETER_SALESFORCE_LOGIN_URL";
    public static final String SALESFORCE_LOGIN_KEY = "PARAMETER_SALESFORCE_LOGIN";
    public static final String SALESFORCE_PASSWORD_KEY = "PARAMETER_SALESFORCE_PASSWORD";
...
//    public static final String REMOTE_ACCESSKEY_KEY = "PARAMETER_REMOTE_ACCESSKEY";
    ...
    public static final String XPATH_SALESFORCE_LOGIN_NAME_FIELD_KEY = "XPATH_SALESFORCE_LOGIN_NAME_FIELD";
    public static final String XPATH_SALESFORCE_PASSWORD_FIELD_KEY = "XPATH_SALESFORCE_PASSWORD_FIELD";
...
//    public static final String XPATH_HEADER_WHYBUY_OVERVIEW_LINK_KEY = "XPATH_HEADER_WHYBUY_OVERVIEW_LINK";
    ...
    public static final String TEST_DEMO001_KEY = "TEST_DEMO001";
    public static final String TEST_DEMO002_KEY = "TEST_DEMO002";
    public static final String TEST_DEMO003_KEY = "TEST_DEMO003";
    public static final String TEST_DEMO004_KEY = "TEST_DEMO004";

    public static void initialize(HashMap<String, String> parameterMapInput){ //This method initializes each of the InputParameters supplied in the configuration map. the keys should be supplied from the above
        //default map keys
    ...
    public static String getParameter(String parameterKey){ //this method returns a parameter from the map. if there is no initialized value for the requested parameter, then this method returns the default or null
        ...
        else
        {
            ...
            try {
                parameterValue = (String) InputParameters.class.getField(defaultStringName).get(parameterValue);
            }
    ...
    public static String getXPath(String xPathKey){ //this method returns a parameter from the map. if there is no initialized value for the requested parameter, then this method returns the default or null
        ...
        else
        {
            ...
            try {
                xPathValue = (String) InputParameters.class.getField(defaultXPathName).get(xPathValue);
            }
            catch (Exception noSuchField)
            {
    ...
    public static String getTest(String testKey){ //this method returns a parameter from the map. if there is no initialized value for the requested parameter, then this method returns the default or null
        ...
        else
        {
            ...
            try {
                testValue = (String) InputParameters.class.getField(defaultTestName).get(testValue);
            }
            catch (Exception noSuchField)
            {
