...
import test.suites.TestCases;
import Utilities.dataReaders.XMLParser;
...
public class TestRunner extends DefaultHandler  {
	    ...
	    public static void main (String args[]) throws FileNotFoundException {
	        ...
	        InputParameters.initialize(configMap);           //sets all of the configurable parameters which have been captured in the confby XMLParser. if a parameter fails to initialize, then the default value
